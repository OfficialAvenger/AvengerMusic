...
async def get_thumb(videoid):
    ...
    arial = ImageFont.truetype("AvengerMusic/assets/font2.ttf", 30)
    font = ImageFont.truetype("AvengerMusic/assets/font.ttf", 30)
    title_font = ImageFont.truetype("AvengerMusic/assets/font3.ttf", 45)
    ...
    play_icons = Image.open("AvengerMusic/assets/play_icons.png")
