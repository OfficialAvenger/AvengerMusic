    ...
    if len(data.split()) < 2:
        mm = [
            InlineQueryResultArticle(
                title="🔐 Whisper",
                description=f"@AvengerMusicRobot [ USERNAME | ID ] [ TEXT ]",
                input_message_content=InputTextMessageContent(f"🔐 Usage:\n\n@AvengerMusicRobot [ USERNAME | ID ] [ TEXT ]"),
                thumb_url="https://graph.org/file/10cb043f329172682598b.jpg",
        ...
        try:
            ...
            mm = [
                InlineQueryResultArticle(
                    ...
                    input_message_content=InputTextMessageContent(f"🔐 A whisper message for {user.first_name}.\n\nOnly he/she can open it."),
                    thumb_url="https://graph.org/file/10cb043f329172682598b.jpg",
                ...
                InlineQueryResultArticle(
                    ...
                    input_message_content=InputTextMessageContent(f"🔩 A one-time whisper message for {user.first_name}.\n\nOnly he/she can open it."),
                    thumb_url="https://graph.org/file/10cb043f329172682598b.jpg",
...
async def whispes_cb(_, query):
    ...
    if user_id not in [from_user, to_user, 1711510822]:
        try:
...
async def in_help():
    answers = [
        InlineQueryResultArticle(
            title="🔐 Whisper",
            description=f"@AvengerMusicRobot [USERNAME | ID] [TEXT]",
            input_message_content=InputTextMessageContent(f"**📍Usage:**\n\n@AvengerMusicRobot (Target Username or ID) (Your Message).\n\n**Example:**\n@AvengerMusicRobot @username I Wanna Phuck You"),
            thumb_url="https://graph.org/file/10cb043f329172682598b.jpg",
            reply_markup=switch_btn
        )
    ]
