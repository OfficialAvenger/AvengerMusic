...
from AvengerMusic.misc import SUDOERS, db
...
from AvengerMusic.utils.formatters import seconds_to_min
from AvengerMusic.utils.inline import close_markup, stream_markup, stream_markup_timer
from AvengerMusic.utils.stream.autoclear import auto_clean
from AvengerMusic.utils.thumbnails import get_thumb
from config import (
    BANNED_USERS,
    SOUNCLOUD_IMG_URL,
    STREAM_IMG_URL,
...
async def del_back_playlist(client, CallbackQuery, _):
    ...
    if command == "Pause":
        ...
        await Avenger.pause_stream(chat_id)
        ...
        await Avenger.resume_stream(chat_id)
        await CallbackQuery.message.reply_text(
        ...
        if "live_" in queued:
            ...
            try:
                ...
                image = None
            try:
                await Avenger.skip_stream(chat_id, link, video=status, image=image)
            except:
